...
const animeData = [
  {
    ...
    "image": "https://gamek.mediacdn.vn/133514250583805952/2022/5/2/photo-1-165147934230063090136.jpg",
    "episode": "01"
  },
  {
    "id": "2",
    ...
    "image": "https://media.vov.vn/sites/default/files/styles/large/public/2022-10/4_6.jpeg.jpg",
    "episode": "1018"
  },
  {
    "id": "3",
    ...
    "image": "https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_topic/horizental_poster-31b17376895e-1649834188425-hGJ9nsYM.jpg",
    "episode": "250"
  },
  {
    "id": "4",
    ...
    "image": "https://www.infobae.com/resizer/v2/J4DE5SXU4VFMJNRC4TBV2C57II.jpg?auth=9b294c32ad25a62577d92b08071b6b692a7b4bbc59f04b4c58ea62c91fa46cce&smart=true&width=992&height=558&quality=85",
    "episode": "07"
  },
  {
    "id": "5",
  ...
  },
  {
    ...
    "image": "https://cdn-media.sforum.vn/storage/app/media/wp-content/uploads/2023/12/Captain-Tsubasa-Ace-1-1.jpg",
    "episode": "28"
  },
  {
    "id": "7",
    ...
    "image": "https://skdesu.com/wp-content/uploads/2023/07/ao-ashi.webp",
    "episode": "28"
  }
...
const App = () => {
  const [selectAnime, setSelectionAnime] = useState(animeData[0]);

  return (
    <div className="bg-gray-900 min-h-screen text-white font-sans">
      <Header></Header>
      <Banner anime={selectAnime} />
      <NewRelease animeList={animeData} onSelect={setSelectionAnime}/>
